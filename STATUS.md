...
| GS-204 | Fail-closed, manifest-driven portable/system packaging | PARTIAL | S19 | Shared fresh staging + required non-empty files, explicit headless/Windows targets; 36 Linux checks (30 + 2 required-file cases S18 + 4 Qt LGPL cases S19) include both packagers, real native CLI artifacts and deployer fixtures. Actual Qt deployment/runtime and binary architecture checks remain unverified | **P1-26** — Real Windows deployment and clean-machine smoke; retain the U-09 blocker (U-08 closed S19); see `docs/planning/SEQUENTIAL_WORK_HANDOFF.md` |
