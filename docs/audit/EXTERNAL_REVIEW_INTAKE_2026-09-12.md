...
**CI evidence for these corrections:** branch run `34707532582` at commit `ddc4194`
(`arena/01a0968e-gifscythe`) was linux + windows green, including the documentation status gate that
failed in run `34705247115`. That branch is now **merged as PR #16 (`629135a`)**, and **`main` run
`34709202307` is green on both jobs**.
