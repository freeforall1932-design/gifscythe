...
**Status:** ✅ **FIXED (S30)** — register §5 `U-59`. GUI ordinary-output runs now use the shared verified-partial promotion lifecycle; Qt-enabled PR CI run 36227237540 passed Linux and Windows builds and both offscreen harnesses. See the U-59 register row below; the independent review remains a separate next-agent follow-up.
