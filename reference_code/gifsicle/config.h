/* config.h - handwritten for a native Linux/gcc build (gifsicle engine).
   Normally generated by configure; handwritten here because the sandbox has
   no autotools and apt is offline. Used only for the gifsicle engine
   reference build (P0/P1). */
