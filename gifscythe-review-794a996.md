...
**State:** FIXED (S23) — confirmed with executed proof in web/test/transport.test.mjs · **Severity:** Medium · **Surface:** web / server.mjs
...
**State:** FIXED (S23) — confirmed with executed proof in web/test/transport.test.mjs · **Severity:** Low · **Surface:** web / server.mjs
...
**State:** FIXED (S23) — dynamic VERSION.md extraction applied · **Severity:** Low · **Surface:** web / wasm tooling
